  ...
  try {
    ...
    const html = `<!doctype html>
      <html lang="es">
        <head>
          <meta charset="utf-8" />
          <title>${escapeHtml(invoice.invoiceNumber)} | Comprobante interno Mikaelson OS</title>
          <style>
        ...
        <body>
          <p style="letter-spacing: .22em; text-transform: uppercase; color: #0891b2; font-weight: 700;">Mikaelson OS</p>
