...
export function AccessRecoveryModal({ open, onClose }: AccessRecoveryModalProps) {
      ...
      <div className="w-full max-w-md rounded-[1.8rem] border border-white/12 bg-slate-950/96 p-6 shadow-[0_30px_90px_rgba(2,6,23,0.52)]">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <h3 className="mt-2 text-2xl font-semibold text-white">Olvide...</h3>
          </div>
          <button
